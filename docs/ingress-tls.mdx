...
- `nginx.ingress.kubernetes.io/proxy-body-size: "10m"` - caps API spec uploads. NGINX's own default is 1m, which rejects larger specs with `413 Request Entity Too Large`.
