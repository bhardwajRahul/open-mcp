...
If you've overridden any of `web.baseUrl`, `mcpServer.baseUrl`, `mcpInspector.baseUrl`, or `keycloak.hostname` in your values, mirror those changes in your ingress (the chart-managed Ingress picks them up automatically).
